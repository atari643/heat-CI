...
sonar.cxx.includeDirectories=/usr/lib/gcc/x86_64-linux-gnu/11/include, /usr/local/include, /usr/include/x86_64-linux-gnu, /usr/lib/x86_64-linux-gnu/openmpi/include/, /usr/include, ., include
